...
/**
 * Shared repair action used by both `devilroute runtime repair` and the
 * top-level `devilroute repair` alias. Reinstalls better-sqlite3 into the
...
export function registerRuntime(program) {
  ...
  // Top-level discoverability alias: `devilroute repair` invokes the SAME action
  // as `devilroute runtime repair` (no duplicated logic). Surfaced in the
