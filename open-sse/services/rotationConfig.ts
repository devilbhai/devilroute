 ...
 *
 * DevilRoute's account-fallback engine (accountFallback.ts) historically rotated accounts using
 ...
 *   - master enable                            DEVILROUTE_ROTATION_ENABLED               (default true)
 *   - rate-limit reset/cooldown seconds        DEVILROUTE_ROTATION_RATE_LIMIT_RESET_SECONDS (0 => engine default)
 *   - per-status fallback enable               DEVILROUTE_ROTATE_ON_{429,500,502,400}    (429/500/502 default true, 400 default false)
 *   - per-status threshold (errors in window)  DEVILROUTE_ROTATE_{status}_THRESHOLD      (default 1 => immediate, current behavior)
 *   - per-status window seconds                DEVILROUTE_ROTATE_{status}_WINDOW_SECONDS (default 120)
 *
...
const GLOBAL_KEY = "__devilroute_rotation_config__";
...
function buildFromEnv(): RotationConfig {
  return {
    enabled: envBool("DEVILROUTE_ROTATION_ENABLED", true),
    rateLimitResetMs: envInt("DEVILROUTE_ROTATION_RATE_LIMIT_RESET_SECONDS", 0, 0) * 1000,
    disableTagWithoutReset: envBool("DEVILROUTE_ROTATION_DISABLE_TAG_WITHOUT_RESET", true),
    rateLimit429: buildClass(
      "DEVILROUTE_ROTATE_ON_429",
      "DEVILROUTE_ROTATE_429_THRESHOLD",
      "DEVILROUTE_ROTATE_429_WINDOW_SECONDS",
      true
    ),
    serverError500: buildClass(
      "DEVILROUTE_ROTATE_ON_500",
      "DEVILROUTE_ROTATE_500_THRESHOLD",
      "DEVILROUTE_ROTATE_500_WINDOW_SECONDS",
      true
    ),
    badGateway502: buildClass(
      "DEVILROUTE_ROTATE_ON_502",
      "DEVILROUTE_ROTATE_502_THRESHOLD",
      "DEVILROUTE_ROTATE_502_WINDOW_SECONDS",
      true
    ),
    badRequest400: buildClass(
      "DEVILROUTE_ROTATE_ON_400",
      "DEVILROUTE_ROTATE_400_THRESHOLD",
      "DEVILROUTE_ROTATE_400_WINDOW_SECONDS",
      false
    ),
  };
}
...
const COUNTER_KEY = "__devilroute_rotation_counters__";
