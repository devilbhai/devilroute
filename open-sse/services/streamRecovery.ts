 ...
 * DevilRoute keeps the holdback OFF by default (see ResilienceSettings.streamRecovery)
...
// Terminal SSE markers DevilRoute emits across formats: OpenAI `data: [DONE]`,
