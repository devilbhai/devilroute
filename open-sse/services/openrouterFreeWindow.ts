 ...
 *
 * Bucketed by ACCOUNT, not by connection/key — multiple DevilRoute connections
 * that share one upstream OpenRouter account must share one window. DevilRoute's
