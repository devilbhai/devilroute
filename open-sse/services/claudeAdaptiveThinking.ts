 ...
 * (Anthropic's current model migration guidance). DevilRoute can still produce a manual
 ...
 * This contract is verified for DevilRoute's two direct Anthropic API providers:
