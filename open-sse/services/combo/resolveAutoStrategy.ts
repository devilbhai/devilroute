...
export interface ResolveAutoStrategyDeps {
  ...
  relayOptions?: {
    ...
    sessionId?: string | null;
    /** Per-request X-DevilRoute-Mode value (#6024/#6025). */
    mode?: string | null;
    /** Per-request X-DevilRoute-Budget value in USD (#6023). */
    budgetCap?: number | null;
    /** Per-request X-DevilRoute-Budget-Fallback value ("cheapest" | "strict") — #3470. */
...
export async function resolveAutoStrategyOrder(
  ...
  // Per-request overrides (#6023 / #6024 / #6025 / #3470): X-DevilRoute-Budget,
  // X-DevilRoute-Budget-Fallback and X-DevilRoute-Mode headers (threaded via
  ...
  // per-request X-DevilRoute-Mode override — but `scoreAutoTargets()` (the fallback
