...
export const SKIP_UNIVERSAL_HANDOFF_FLAG = "_devilrouteSkipUniversalHandoff";
...
async function generateHandoffAsync(options: {
  ...
  const summaryBody = {
    ...
    temperature: 0.1,
    _devilrouteSkipContextRelay: true,
    _devilrouteInternalRequest: "context-handoff",
  };
...
async function generateUniversalHandoffAsync(options: {
  ...
  const summaryBody: Record<string, unknown> = {
    ...
    temperature: 0.1,
    _devilrouteSkipContextRelay: true,
    _devilrouteInternalRequest: "universal-handoff",
  };
