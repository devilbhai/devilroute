/**
 * MCP Tool Schemas — Contracts for all 23 core and advanced DevilRoute MCP tools.
 *
 ...
 *
 * Each tool wraps existing DevilRoute API endpoints and exposes them through
...
export const getHealthTool: McpToolDefinition<typeof getHealthInput, typeof getHealthOutput> = {
  name: "devilroute_get_health",
  description:
    "Returns the current health status of DevilRoute including uptime, memory usage, circuit breaker states for all providers, rate limit status, and cache statistics.",
...
// --- Tool 3: devilroute_get_combo_metrics ---
...
> = {
  name: "devilroute_get_combo_metrics",
  description:
...
// --- Tool 4: devilroute_switch_combo ---
...
// --- Tool 6: devilroute_route_request ---
...
> = {
  ...
  description:
    "Sends a chat completion request through DevilRoute's intelligent routing pipeline. Supports combo selection, budget limits, and task role hints for optimal provider matching.",
...
// --- Tool 8: devilroute_list_models_catalog ---
...
> = {
  name: "devilroute_list_models_catalog",
  description:
...
export const webSearchTool: McpToolDefinition<typeof webSearchInput, typeof webSearchOutput> = {
  name: "devilroute_web_search",
  description:
    "Performs a web search using DevilRoute's search gateway. Supports multiple providers (Serper, Brave, Perplexity, Exa, Tavily, Google PSE, Linkup, SearchAPI, SearXNG) with automatic failover. Returns search results with titles, URLs, snippets, and position data.",
...
export const webFetchTool: McpToolDefinition<typeof webFetchInput, typeof webFetchOutput> = {
  name: "devilroute_web_fetch",
  description:
    "Fetches and extracts content from a URL using DevilRoute's web fetch gateway. Supports multiple providers (Firecrawl, Jina Reader, Tavily, TinyFish) with automatic failover. Returns the page content as markdown, HTML, links, or screenshot, along with metadata.",
...
// --- Tool 9: devilroute_simulate_route ---
...
// --- Tool 10: devilroute_set_budget_guard ---
...
> = {
  name: "devilroute_set_budget_guard",
  description:
...
// --- Tool 11: devilroute_set_routing_strategy ---
...
> = {
  name: "devilroute_set_routing_strategy",
  description:
...
// --- Tool 12: devilroute_set_resilience_profile ---
...
> = {
  name: "devilroute_set_resilience_profile",
  description:
...
// --- Tool 14: devilroute_get_provider_metrics ---
...
> = {
  name: "devilroute_get_provider_metrics",
  description:
...
// --- Tool 15: devilroute_best_combo_for_task ---
...
> = {
  name: "devilroute_best_combo_for_task",
  description:
...
// --- Tool 16: devilroute_explain_route ---
...
// --- Tool 17: devilroute_get_session_snapshot ---
...
> = {
  name: "devilroute_get_session_snapshot",
  description:
...
// --- Tool 18: devilroute_db_health_check ---
...
> = {
  name: "devilroute_db_health_check",
  description:
    "Diagnoses DevilRoute database drift such as orphan quota/domain rows, invalid JSON state, and broken combo references. Set autoRepair=true to repair those rows before returning the report.",
...
// --- Tool 19: devilroute_sync_pricing ---
...
export const syncPricingTool: McpToolDefinition<typeof syncPricingInput, typeof syncPricingOutput> =
  {
    name: "devilroute_sync_pricing",
    description:
      "Syncs pricing data from external sources (LiteLLM) into DevilRoute. Synced pricing fills gaps not covered by hardcoded defaults without overwriting user-set prices. Use dryRun=true to preview.",
...
> = {
  name: "devilroute_compression_status",
  description:
...
> = {
  name: "devilroute_compression_configure",
  description:
...
> = {
  name: "devilroute_set_compression_engine",
...
> = {
  name: "devilroute_list_compression_combos",
...
> = {
  name: "devilroute_compression_combo_stats",
...
> = {
  name: "devilroute_oneproxy_fetch",
  description:
...
> = {
  name: "devilroute_oneproxy_rotate",
  description:
...
> = {
  name: "devilroute_oneproxy_stats",
  description:
...
> = {
  name: "devilroute_agent_skills_list",
  description:
    "List DevilRoute agent skills with optional filtering by category (api/cli) or area. Returns skill metadata including id, name, description, endpoints/commands, and URLs.",
...
> = {
  name: "devilroute_agent_skills_get",
  description:
...
// --- devilroute_agent_skills_coverage ---
...
> = {
  name: "devilroute_agent_skills_coverage",
  description:
