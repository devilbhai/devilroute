/**
 * DevilRoute MCP Session Pool Tools — Manage and monitor anonymous web session pools.
 *
 * Tools:
 *   1. devilroute_pool_status   — Get pool stats for one or all providers
 *   2. devilroute_pool_sessions — List per-session details for a provider's pool
 *   3. devilroute_pool_reset    — Shut down and recreate a pool
 *   4. devilroute_pool_warm     — Warm up a pool to a target session count
 *   5. devilroute_pool_health   — Aggregated pool health with breaker state and issues
 */
...
export const poolTools = {
  devilroute_pool_status: {
    name: "devilroute_pool_status",
    description:
  ...
  devilroute_pool_sessions: {
    name: "devilroute_pool_sessions",
    description:
  ...
  devilroute_pool_reset: {
    name: "devilroute_pool_reset",
    description:
  ...
  devilroute_pool_warm: {
    name: "devilroute_pool_warm",
    description:
  ...
  devilroute_pool_health: {
    name: "devilroute_pool_health",
    description:
  ...
  devilroute_browser_pool_status: {
    name: "devilroute_browser_pool_status",
    description:
