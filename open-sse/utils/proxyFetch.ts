...
const PATCH_STATE_KEY = Symbol.for("devilroute.proxyFetch.state");
 ...
 *
 * This remains disabled unless DEVILROUTE_CONTROL_PLANE_PROXY_DIRECT_FALLBACK is enabled
...
async function patchedFetch(
  ...
  if (
    ...
    if (process.env.DEVILROUTE_PROXY_FETCH_DEBUG === "true") {
