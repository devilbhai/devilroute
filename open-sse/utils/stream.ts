...
import { buildDevilRouteSseMetadataComment } from "@/domain/devilrouteResponseMeta";
import {
...
export const PENDING_REQUEST_CLEARED_MARKER = "__devilroutePendingRequestCleared";
            ...
            if (trimmed.startsWith("data:") && trimmed.slice(5).trim() !== "[DONE]") {
              try {
                ...
                if (isResponsesSSE) {
                  ...
                  // chunk like "[DevilRoute] Upstream returned an empty response. Please
