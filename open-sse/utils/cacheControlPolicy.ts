 ...
 * vs. applying DevilRoute's own caching strategy.
 *
 ...
 * strategies) forced DevilRoute to strip the client's markers and re-derive
 ...
 * @returns true if cache_control should be preserved, false if DevilRoute should manage it
 */
