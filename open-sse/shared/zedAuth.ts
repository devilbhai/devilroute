 ...
 *
 *   1. The client (DevilRoute) generates an ephemeral RSA keypair.
 ...
 *   5. DevilRoute decrypts the access token locally with the private key that
 ...
 * adapted to TypeScript + DevilRoute conventions. `fetch` is intentionally the
