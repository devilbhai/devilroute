 ...
 */
import { buildErrorBody } from "@devilroute/open-sse/utils/error.ts";
import { getCircuitBreaker } from "@/shared/utils/circuitBreaker";
import { isModelLocked } from "@devilroute/open-sse/services/accountFallback.ts";
...
export async function getAutoComboCandidates(
  ...
  if (channel === "auto") {
    ...
    const { createBuiltinAutoCombo } =
      await import("@devilroute/open-sse/services/autoCombo/builtinCatalog.ts");
