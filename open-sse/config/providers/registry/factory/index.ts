...
// local `droid` CLI. DevilRoute already integrates Droid as a CLI tool at
...
// Factory Droids subscription can proxy traffic through DevilRoute.
//
...
// back to stored CLI credentials only when omitted. DevilRoute does NOT read
