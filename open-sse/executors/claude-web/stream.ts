...
function responseHeaders(contentType: string, metadata: Record<string, string>): Headers {
  ...
  const headerNames: Record<string, string> = {
    operation: "X-DevilRoute-Claude-Web-Operation",
    conversation_id: "X-DevilRoute-Claude-Web-Conversation-Id",
    parent_message_uuid: "X-DevilRoute-Claude-Web-Parent-Message-Uuid",
    assistant_message_uuid: "X-DevilRoute-Claude-Web-Assistant-Message-Uuid",
  };
