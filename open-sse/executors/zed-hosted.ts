 ...
 * to OpenAI Chat Completions chunks by reusing DevilRoute's own translators
 ...
 * adapted to TypeScript + DevilRoute's BaseExecutor/translator conventions.
...
function resolveZedSuppressThinkClose(
  ...
  return resolveSuppressThinkClose({
    ...
    thinkingMarkerHeader:
      ...
      clientHeaders?.["x-devilroute-thinking-marker"] ??
      null,
    ...
    const response = await zedLlmFetch(zedCredentials, "/completions", {
      ...
      fetchOptions: {
        ...
        headers: {
          ...
          "User-Agent": `DevilRoute/zed-hosted`,
