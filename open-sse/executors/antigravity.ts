...
function sanitizeAntigravityGeminiRequest(
  ...
  // Missing settings stay absent so DevilRoute does not silently weaken upstream safety.
...
export class AntigravityExecutor extends BaseExecutor {
  ...
  async transformRequest(
    ...
    // Opt-in escape hatch: set DEVILROUTER_ALLOW_BODY_PROJECT_OVERRIDE=1.
    ...
    const allowBodyProjectOverride = process.env.DEVILROUTE_ALLOW_BODY_PROJECT_OVERRIDE === "1";
    ...
    // Opt-in escape hatch: set DEVILROUTE_ALLOW_BODY_PROJECT_OVERRIDE=1.
    let projectId =
