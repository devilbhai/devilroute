...
export async function GET(request) {
  try {
    ...
    const { getQuotaMonitorSummary } = await import("@devilroute/open-sse/services/quotaMonitor.ts");
    const { getActiveSessions } = await import("@devilroute/open-sse/services/sessionManager.ts");
