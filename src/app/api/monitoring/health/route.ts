...
export async function GET() {
  ...
  try {
    const [
      ...
      import("@devilroute/open-sse/services/rateLimitManager"),
      import("@devilroute/open-sse/services/accountFallback"),
      import("@devilroute/open-sse/services/requestDedup.ts"),
      import("@devilroute/open-sse/services/quotaMonitor.ts"),
      import("@devilroute/open-sse/services/sessionManager.ts"),
