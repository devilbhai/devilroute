 ...
 * Exports a legacy DevilRoute-compatible JSON backup.
 */
  ...
  try {
    ...
    const exportData: Record<string, unknown> = {
      ...
      _meta: {
        ...
        version: "devilroute-v3-legacy-export",
    ...
    return new NextResponse(JSON.stringify(exportData, null, 2), {
      ...
      headers: {
        ...
        "Content-Disposition": `attachment; filename="devilroute-legacy-backup-${new Date().toISOString().replace(/[:.]/g, "-")}.json"`,
      },
    });
  } catch (error) {
