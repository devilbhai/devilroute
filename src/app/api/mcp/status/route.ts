...
import { getAuditStats, queryAuditEntries } from "@devilroute/open-sse/mcp-server/audit";
import {
  isMcpHeartbeatOnline,
  isProcessAlive,
  readMcpHeartbeat,
  resolveMcpHeartbeatPath,
} from "@devilroute/open-sse/mcp-server/runtimeHeartbeat";
import {
  getMcpHttpStatus,
...
export async function GET(request: Request) {
  ...
  try {
    ...
    const scopesEnforced = process.env.DEVILROUTE_MCP_ENFORCE_SCOPES === "true";
