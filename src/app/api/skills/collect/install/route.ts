 ...
 * Uses DevilRoute's skill registry + CLI tool paths (no Skill Collector bridge).
 *
 * Body: {
...
import { sanitizeErrorMessage, buildErrorBody } from "@devilroute/open-sse/utils/error";
