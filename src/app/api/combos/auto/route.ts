...
import {
  VALID_VARIANTS,
  type AutoVariant,
} from "@devilroute/open-sse/services/autoCombo/autoPrefix";
import {
  AUTO_SUFFIX_VARIANTS,
  AUTO_TEMPLATE_VARIANTS,
  AUTO_FAMILY_IDS,
} from "@devilroute/open-sse/services/autoCombo/builtinCatalog";
import { parseAutoSuffix } from "@devilroute/open-sse/services/autoCombo/suffixComposition";
...
export async function GET(request: Request) {
  ...
  try {
    const { createVirtualAutoCombo } =
      await import("@devilroute/open-sse/services/autoCombo/virtualFactory");
