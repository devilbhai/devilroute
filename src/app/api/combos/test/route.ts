...
import { resolveNestedComboTargets } from "@devilroute/open-sse/services/combo.ts";
    ...
    try {
      res = await fetch(internalUrl, {
        ...
        headers: {
          ...
          // DevilRoute's semantic cache or other request reuse layers.
          "X-DevilRoute-No-Cache": "true",
          ...(target.connectionId ? { "X-DevilRoute-Connection": target.connectionId } : {}),
