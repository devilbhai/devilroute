import { handleVideoGeneration } from "@devilroute/open-sse/handlers/videoGeneration.ts";
import { resolveVideoCredentialProvider } from "@devilroute/open-sse/handlers/videoGeneration/googleFlow.ts";
import { withInjectionGuard } from "@/middleware/promptInjectionGuard";
import {
  getProviderCredentialsWithQuotaPreflight,
  clearRecoveredProviderState,
} from "@/sse/services/auth";
import { parseVideoModel, getVideoProvider } from "@devilroute/open-sse/config/videoRegistry.ts";
