...
import { handleAudioTranscription } from "@devilroute/open-sse/handlers/audioTranscription.ts";
import {
...
import { attachDevilRouteMetaToResponse } from "@/domain/devilrouteResponseMeta";
...
export async function POST(request) {
  ...
  if (response?.ok) {
    ...
    response = attachDevilRouteMetaToResponse(response, {
      provider,
      model: resolvedModel,
      costUsd: 0,
