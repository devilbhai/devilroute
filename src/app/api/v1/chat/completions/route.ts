...
import { initTranslators } from "@devilroute/open-sse/translator/index.ts";
...
} from "@devilroute/open-sse/utils/earlyStreamKeepalive";
import { resolveKeepaliveThreshold } from "@devilroute/open-sse/utils/keepaliveThreshold";
import {
  admitChatRequest,
  admitChatStructure,
...
export async function POST(request) {
  ...
  try {
    ...
    // typical chat payloads. Toggle off via DEVILROUTE_LOG_REQUEST_SHAPE=0.
    if (process.env.DEVILROUTE_LOG_REQUEST_SHAPE !== "0") {
