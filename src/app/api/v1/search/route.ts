import { handleSearch } from "@devilroute/open-sse/handlers/search.ts";
import {
...
} from "@devilroute/open-sse/config/searchRegistry.ts";
...
} from "@devilroute/open-sse/services/searchCache.ts";
import {
