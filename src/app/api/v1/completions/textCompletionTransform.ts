/**
 * #3571 — `/v1/completions` is the legacy OpenAI Completions API. DevilRoute routes
 ...
 * the model they asked for, and the `x-devilroute-model` response header
 ...
 * requested identifier (matching the `x-devilroute-model` response header).
 */
