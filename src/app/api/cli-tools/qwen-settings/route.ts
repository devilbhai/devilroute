...
export async function GET(request: Request): Promise<Response> {
  ...
  try {
    ...
    return NextResponse.json({
      ...runtime,
      settings,
      hasDevilRoute: hasDevilRouteQwenCodeConfig(settings),
...
export async function POST(request: Request): Promise<Response> {
  ...
  try {
    ...
    if (!apiKey) apiKey = "sk_devilroute";
    ...
    return NextResponse.json({
      success: true,
      message: "Qwen Code now routes through DevilRoute",
      settingsPath: configPaths.settings,
      envPath: configPaths.env,
    });
  } catch (error) {
...
export async function DELETE(request: Request): Promise<Response> {
  ...
  try {
    ...
    return NextResponse.json({
      success: true,
      message: "DevilRoute settings removed from Qwen Code",
    });
  } catch (error) {
