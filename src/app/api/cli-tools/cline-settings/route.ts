...
// Check if DevilRoute is configured as OpenAI-compatible provider
const hasDevilRouteConfig = (globalState: any) => {
...
export async function GET(request: Request) {
  ...
  try {
    ...
    return NextResponse.json({
      ...
      hasDevilRoute: hasDevilRouteConfig(globalState),
...
// POST - Configure Cline to use DevilRoute as OpenAI-compatible provider
export async function POST(request: Request) {
  ...
  try {
    ...
    secrets.openAiApiKey = apiKey || "sk_devilroute";
...
// DELETE - Remove DevilRoute OpenAI-compatible provider config
export async function DELETE(request: Request) {
  ...
  try {
    ...
    return NextResponse.json({
      success: true,
      message: "DevilRoute settings removed from Cline",
    });
  } catch (error) {
