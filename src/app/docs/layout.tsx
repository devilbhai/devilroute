...
export const metadata = {
  title: {
    template: "%s — DevilRoute Docs",
    default: "DevilRoute Documentation",
  },
  description:
    "Comprehensive documentation for DevilRoute AI gateway — setup, API, compression, deployment, and more.",
  robots: {
    index: true,
    follow: true,
  },
