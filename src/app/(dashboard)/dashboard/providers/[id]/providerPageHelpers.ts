...
import { getRegistryEntry } from "@devilroute/open-sse/config/providerRegistry";
import type { AlternateFormat } from "@devilroute/open-sse/config/providers/alternateFormats";
import {
