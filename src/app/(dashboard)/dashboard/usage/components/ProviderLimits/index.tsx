...
const LS_PURCHASE_FILTER = "devilroute:limits:purchaseFilter";
const LS_STATUS_FILTER = "devilroute:limits:statusFilter";
const LS_ENV_FILTER = "devilroute:limits:envFilter";
const LS_PROVIDER_FILTER = "devilroute:limits:providerFilter";
