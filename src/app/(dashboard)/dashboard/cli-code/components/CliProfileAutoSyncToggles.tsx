...
const CODEX_KEY = "DEVILROUTE_AUTO_SYNC_CODEX_PROFILES";
const CLAUDE_KEY = "DEVILROUTE_AUTO_SYNC_CLAUDE_PROFILES";
 ...
 * Reads/writes the DEVILROUTE_AUTO_SYNC_{CODEX,CLAUDE}_PROFILES feature flags via
