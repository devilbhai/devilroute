...
/**
 * Maps Arena leaderboard categories to DevilRoute task-type categories.
 *
...
/**
 * DevilRoute model aliases: canonical name → known aliases.
 * Creates additional DB entries for each alias so that models
 * are findable under any name DevilRoute uses internally.
 */
 ...
 *
 * Leaderboard categories are mapped to DevilRoute task types:
 * - "text" → default, review, documentation, debugging
 * - "code" → coding
 *
 * Known DevilRoute model aliases are also expanded into additional entries.
 *
