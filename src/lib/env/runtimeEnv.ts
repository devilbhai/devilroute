...
export const webRuntimeEnvSchema = z.object({
  ...
  DEVILROUTE_DISABLE_BACKGROUND_SERVICES: optionalBooleanEnv,
  CLOUD_URL: optionalHttpUrl,
  NEXT_PUBLIC_CLOUD_URL: optionalHttpUrl,
  DEVILROUTE_PUBLIC_BASE_URL: optionalHttpUrl,
  DEVILROUTE_BASE_URL: optionalHttpUrl,
  BASE_URL: optionalHttpUrl,
  NEXT_PUBLIC_BASE_URL: optionalHttpUrl,
  DEVILROUTE_PORT: optionalPortEnv,
