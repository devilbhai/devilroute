/**
 * Container runtime providers for the DevilRoute skill sandbox.
 *
 * The sandbox historically hardcoded the `docker` CLI. This module abstracts
 * the container runtime so DevilRoute can pick the most performant / native
...
const SANDBOX_NAME = (sandboxId: string) => `devilroute-${sandboxId}`;
