...
import { DEVILROUTE_WEB_SEARCH_FALLBACK_TOOL_NAME } from "@devilroute/open-sse/services/webSearchFallback.ts";
import { DEVILROUTE_WEB_FETCH_FALLBACK_TOOL_NAME } from "@devilroute/open-sse/services/webFetchInterception.ts";
...
const BUILTIN_TOOL_ALIASES: Record<string, string> = {
  [DEVILROUTE_WEB_SEARCH_FALLBACK_TOOL_NAME]: "web_search",
  [DEVILROUTE_WEB_FETCH_FALLBACK_TOOL_NAME]: "web_fetch",
};
...
export async function handleToolCallExecution(
  ...
  switch (provider) {
    ...
    case "anthropic": {
      ...
      // blocks untouched, remove the DevilRoute-handled tool_use blocks, and expose
