...
function isAutoSyncEnabled() {
  // Opt-in, default OFF. Backed by the DEVILROUTE_AUTO_SYNC_CODEX_PROFILES feature flag
  ...
  return isFeatureFlagEnabled("DEVILROUTE_AUTO_SYNC_CODEX_PROFILES");
}
...
export async function autoSyncCodexProfilesFromLiveCatalog(
  ...
  // Reuse the CLI generator so automatic sync and `devilroute setup-codex`
