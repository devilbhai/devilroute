 ...
 * trace out of DevilRoute into their existing workflow.
 *
 * Secrets are *always* masked on export, regardless of the UI state — see
 * Hard Rule #1 (no credentials in artefacts). The DevilRoute capture source
...
const CREATOR_NAME = "DevilRoute Traffic Inspector";
