...
import {
  ...
  type ScoringWeights,
  validateWeights,
} from "@devilroute/open-sse/services/autoCombo/scoring.ts";
import { getModePack } from "@devilroute/open-sse/services/autoCombo/modePacks.ts";
import { getTaskFitness } from "@devilroute/open-sse/services/autoCombo/taskFitness.ts";
import type {
  ComboAutopilotCombo,
