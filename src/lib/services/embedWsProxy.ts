 ...
 *     is set explicitly. The DevilRoute LOCAL_ONLY rule is enforced at the
...
declare global {
  var __devilrouteEmbedWsStarted: boolean | undefined;
}
...
export function initEmbedWsProxy(): void {
  if (globalThis.__devilrouteEmbedWsStarted) return;
  ...
  server.listen(port, host, () => {
    globalThis.__devilrouteEmbedWsStarted = true;
