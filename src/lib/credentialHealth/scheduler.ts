...
function getSchedulerState() {
  if (!globalThis.__devilrouteCredentialHC) {
    globalThis.__devilrouteCredentialHC = {
      initialized: false,
      sweepTimer: null,
  ...
  return globalThis.__devilrouteCredentialHC;
}
...
function isCredentialHealthCheckDisabled(): boolean {
  ...
  const val = process.env.DEVILROUTE_DISABLE_CREDENTIAL_HEALTH_CHECK;
