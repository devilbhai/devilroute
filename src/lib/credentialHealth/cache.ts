...
declare global {
  var __devilrouteCredentialCache:
    | {
        initialized: boolean;
...
function getCacheState() {
  if (!globalThis.__devilrouteCredentialCache) {
    globalThis.__devilrouteCredentialCache = {
      initialized: false,
      cache: new Map(),
    };
  }
  return globalThis.__devilrouteCredentialCache;
}
