...
import { validateQoderCliPat } from "@devilroute/open-sse/services/qoderCli.ts";
...
export async function validateAuggieProvider() {
  const { checkAuggieCliVersion } = await import("@devilroute/open-sse/executors/auggie.ts");
