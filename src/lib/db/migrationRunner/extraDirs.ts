 ...
 * space: `NNN_name.sql` is recorded in `_devilroute_migrations` as `NNN`. That
 ...
 * namespace:
 *
 *   DEVILROUTE_EXTRA_MIGRATIONS_DIRS="ee=/opt/app/enterprise/db/migrations"
 *
...
export const EXTRA_MIGRATIONS_DIRS_ENV = "DEVILROUTE_EXTRA_MIGRATIONS_DIRS";
