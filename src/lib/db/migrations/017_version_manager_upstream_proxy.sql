...
CREATE TABLE IF NOT EXISTS version_manager (
  ...
  tool              TEXT NOT NULL UNIQUE,           -- 'cliproxyapi' | 'devilroute'
  ...
  auto_start        INTEGER NOT NULL DEFAULT 0,    -- 1 = start with DevilRoute
...
-- Determines whether each provider uses DevilRoute's native executor,
