...
import { PROVIDER_ID_TO_ALIAS } from "@devilroute/open-sse/config/providerModels.ts";
...
export async function resolveProxyForConnection(
  ...
  try {
    const { selectWorkingProxyFallback } = await import("@devilroute/open-sse/utils/proxyFallback");
