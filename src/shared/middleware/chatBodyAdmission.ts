...
export const CHAT_LARGE_BODY_BYTES = parsePositiveInt(
  process.env.DEVILROUTE_CHAT_LARGE_BODY_BYTES,
  256 * 1024
);

export const CHAT_HARD_MAX_BODY_BYTES = parsePositiveInt(
  process.env.DEVILROUTE_CHAT_HARD_MAX_BODY_BYTES,
  50 * 1024 * 1024
);

const CHAT_MAX_HEAVY_IN_FLIGHT = parsePositiveInt(
  process.env.DEVILROUTE_CHAT_MAX_HEAVY_IN_FLIGHT,
  1
);

export const CHAT_HEAVY_MESSAGE_COUNT = parsePositiveInt(
  process.env.DEVILROUTE_CHAT_HEAVY_MESSAGE_COUNT,
  200
);
export const CHAT_HEAVY_TOOL_COUNT = parsePositiveInt(
  process.env.DEVILROUTE_CHAT_HEAVY_TOOL_COUNT,
  64
);
export const CHAT_HEAVY_ESTIMATED_TOKENS = parsePositiveInt(
  process.env.DEVILROUTE_CHAT_HEAVY_ESTIMATED_TOKENS,
  32_000
);
export const CHAT_HARD_MAX_MESSAGES = parsePositiveInt(
  process.env.DEVILROUTE_CHAT_HARD_MAX_MESSAGES,
  800
);
 ...
 * synchronous JavaScript turn, making acquisition atomic within an DevilRoute process.
