...
export const FEATURE_FLAG_DEFINITIONS: FeatureFlagDefinition[] = [
  ...
  {
    key: "DEVILROUTE_CONTROL_PLANE_PROXY_DIRECT_FALLBACK",
  ...
  {
    key: "DEVILROUTE_ALLOW_PRIVATE_PROVIDER_URLS",
  ...
  {
    key: "DEVILROUTE_ALLOW_LOCAL_PROVIDER_URLS",
    label: "Allow Local Provider URLs",
    description:
      "Allow adding and validating providers on local/private addresses (127.0.0.1, localhost, LAN, private IP ranges) — needed for local OpenAI-compatible models. Enabled by default (DevilRoute is local-first); turn it OFF to enforce strict public-only blocking if you only use public providers. Cloud-metadata endpoints (e.g. 169.254.169.254) stay blocked either way.",
  ...
  {
    key: "DEVILROUTE_MCP_ENFORCE_SCOPES",
  ...
  {
    key: "DEVILROUTE_MCP_COMPRESS_DESCRIPTIONS",
  ...
  {
    key: "DEVILROUTE_ENABLE_RUNTIME_BACKGROUND_TASKS",
  ...
  {
    key: "DEVILROUTE_DISABLE_BACKGROUND_SERVICES",
  ...
  {
    key: "DEVILROUTE_RTK_TRUST_PROJECT_FILTERS",
  ...
  {
    key: "DEVILROUTE_CODEX_WS_ENABLED",
  ...
  {
    key: "DEVILROUTE_EMERGENCY_FALLBACK",
  ...
  {
    key: "DEVILROUTE_AUTO_SYNC_CLAUDE_PROFILES",
  ...
  // ──────────────── Health (3) ────────────────
  {
    key: "DEVILROUTE_DISABLE_LOCAL_HEALTHCHECK",
  ...
  {
    key: "DEVILROUTE_DISABLE_TOKEN_HEALTHCHECK",
