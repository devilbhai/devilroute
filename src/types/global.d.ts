/**
 * Global Type Declarations for DevilRoute
 *
...
declare namespace NodeJS {
  interface ProcessEnv {
    ...
    DEVILROUTE_PUBLIC_BASE_URL?: string;
    DEVILROUTE_CGPT_WEB_IMAGE_TIMEOUT_MS?: string;
    DEVILROUTE_CGPT_WEB_IMAGE_CACHE_MAX_MB?: string;
    DEVILROUTE_BASE_URL?: string;
    DEVILROUTE_DISABLE_BACKGROUND_SERVICES?: string;
    DEVILROUTE_PORT?: string;
