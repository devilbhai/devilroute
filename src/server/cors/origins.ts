 ...
 *
 * Source of truth for which browser origins may call DevilRoute over CORS.
...
const STANDARD_ALLOW_HEADERS =
  "Content-Type, Authorization, x-api-key, anthropic-version, x-devilroute-connection, x-internal-test, accept";
