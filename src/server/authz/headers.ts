...
export const AUTHZ_HEADER_ROUTE_CLASS = "x-devilroute-route-class";

export const AUTHZ_HEADER_AUTH_KIND = "x-devilroute-auth-kind";
export const AUTHZ_HEADER_AUTH_ID = "x-devilroute-auth-id";
export const AUTHZ_HEADER_AUTH_LABEL = "x-devilroute-auth-label";
export const AUTHZ_HEADER_AUTH_SCOPES = "x-devilroute-auth-scopes";

/** CLI sends this header so the local process can call management APIs without login. */
export const CLI_TOKEN_HEADER = "x-devilroute-cli-token";
 ...
 * token matches this process's DEVILROUTE_PEER_STAMP_TOKEN (see
 ...
 */
export const PEER_IP_HEADER = "x-devilroute-peer-ip";
 ...
 * proxy hop (e.g. DevilRoute behind nginx / Caddy / Cloudflare Tunnel) is NOT
 ...
 */
export const VIA_PROXY_HEADER = "x-devilroute-via-proxy";
 ...
 */
export const AUTHZ_HEADER_PEER_LOCALITY = "x-devilroute-peer-locality";
