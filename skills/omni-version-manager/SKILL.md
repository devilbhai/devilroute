...
When enabled, 9Router starts automatically on the next DevilRoute boot. **LOCAL_ONLY** — loopback only.
...
When enabled, CLIProxyAPI starts automatically on the next DevilRoute boot. **LOCAL_ONLY** — loopback only.
...
When enabled, Mux starts automatically on the next DevilRoute boot. **LOCAL_ONLY** — loopback only.
...
When enabled, Bifrost starts automatically on the next DevilRoute boot. **LOCAL_ONLY** — loopback only.
