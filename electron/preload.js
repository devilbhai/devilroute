/**
 * DevilRoute Electron Desktop App - Preload Script
 *
...
const MAC_DRAG_STYLE_ID = "devilroute-electron-drag-region-style";
const MAC_DRAG_FALLBACK_ID = "devilroute-electron-drag-region";
const MAC_DRAG_OBSERVER_KEY = "__devilrouteMacDragRegionObserver";
...
function installMacDragRegion() {
  ...
  const attach = () => {
    ...
    style.textContent = `
      header,
      .devilroute-electron-drag-region {
        app-region: drag;
    ...
    dragRegion.className = "devilroute-electron-drag-region";
