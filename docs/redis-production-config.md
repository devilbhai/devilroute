...
Redis is an **optional, soft dependency** in DevilRoute — the application degrades gracefully (in-memory
...
# Persistence (optional — DevilRoute is crash‑safe without it)
