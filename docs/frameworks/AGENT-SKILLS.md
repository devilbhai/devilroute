---
title: "DevilRoute Agent Skills Catalog"
version: 3.8.40
...
Agent Skills are structured SKILL.md files that teach external agents, MCP clients, and A2A orchestrators how to use DevilRoute's REST API and CLI. Unlike [Omni Skills](./SKILLS.md) (which are LLM tool definitions executed inside DevilRoute), Agent Skills are a _documentation catalog_ — static markdown that can be fed directly into agent context.
...
- A **GitHub raw URL** for live fetch: `https://raw.githubusercontent.com/diegosouzapw/DevilRoute/refs/heads/main/skills/{id}/SKILL.md`
...
- [MCP-SERVER.md](./MCP-SERVER.md) — MCP tool catalog (`devilroute_agent_skills_*` tools)
