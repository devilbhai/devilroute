...
> Last updated: 2026-06-28 — DevilRoute v3.8.40
>
...
├── @devilroute/           # Publishable companion packages (opencode-plugin, opencode-provider)
├── skills/               # CLI/agent skill packs (cli-* + omni-* + config-codex-cli)
├── examples/             # Sample plugins + devilroute-cmd-hello starter
...
Separate npm workspace (`@devilroute/open-sse`). Handles request processing + provider execution.
...
| `preload.js`     | IPC bridge (contextBridge → `window.devilroute`)                                   |
...
| File                                                                                                        | Purpose                                                                                                                    |
| ----------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| `devilroute.mjs`                                                                                             | Main CLI entry — `devilroute serve`, `devilroute setup`, `devilroute doctor`, `devilroute providers`, `devilroute combos`, etc. |
...
| File                         | Purpose                                                                            |
| ---------------------------- | ---------------------------------------------------------------------------------- |
| `skills/devilroute*/SKILL.md` | 10 skill manifests for external AI agents (Claude Desktop, ChatGPT, Cursor, Cline) |
...
| `CLI-TOOLS.md`              | External CLI integrations + Internal DevilRoute CLI                                    |
...
- **`_mono_repo/`** — historic subprojects (devilrouteCloud, devilrouteSite, vscode-extension)
