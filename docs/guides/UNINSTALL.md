---
title: "DevilRoute — Uninstall Guide"
version: 3.8.40
lastUpdated: 2026-06-28
---

# DevilRoute — Uninstall Guide
...
This guide covers how to cleanly remove DevilRoute from your system.

---

## Quick Uninstall (v3.6.2+)

DevilRoute provides two built-in scripts for clean removal:
...
This removes the DevilRoute application but **preserves** your database, configurations, API keys, and provider settings in `~/.devilroute/`. Use this if you plan to reinstall later and want to keep your setup.
...
- Backup files
- Log files
- All files in the `~/.devilroute/` directory
...
- Open `Settings → Apps → DevilRoute → Uninstall`
- Or run the NSIS uninstaller from the install directory

**macOS:**

- Drag `DevilRoute.app` from `/Applications` to Trash
- Remove data: `rm -rf ~/Library/Application Support/devilroute`

**Linux:**

- Remove the AppImage file
- Remove data: `rm -rf ~/.devilroute`
...
DevilRoute stores data in the following locations by default:
