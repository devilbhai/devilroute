...
must execute recorded GitHub triage through DevilRoute routing, persist a complete
...
| DEC-002     | Keep issue-agent execution opt-in with `DEVILROUTE_ISSUE_AGENT_ENABLED=true`      | prevents unrequested autonomous execution                                                                      | `implemented` |
