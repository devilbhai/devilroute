...
DevilRoute dostarcza wieloplatformową aplikację desktopową (Windows / macOS / Linux) opartą na
...
| Id aplikacji       | `online.devilroute.desktop` |
| Nazwa produktu     | `DevilRoute`                |
...
- Linux: `$XDG_CONFIG_HOME/devilroute` lub `~/.devilroute`
- macOS: `~/.devilroute`
...
- Przycisk zamknięcia minimalizuje do trayu; menu trayu ma **Open DevilRoute**, **Open Dashboard** (zewnętrzna przeglądarka), podmenu **Server Port**, **Check for Updates**, **Quit**.
