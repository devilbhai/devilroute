...
> **TL;DR**: DevilRoute rankinguje swoje **darmowe** providery według jakości modeli, używając **wyników ELO Arena AI
...
DevilRoute agreguje 160+ providerów, z których wiele udostępnia **darmowy tier** (no-auth,
...
Kategorie rankingu mapują się na kategorie zadań DevilRoute:

| Ranking Arena | Kategorie zadań DevilRoute                         |
| ------------- | ------------------------------------------------- |
...
- Jest **nieblokująca i nigdy nie jest fatalna** — jeśli fetch upstreamu się nie uda, DevilRoute dalej
...
przez DevilRoute, dzięki czemu modele da się znaleźć pod dowolną nazwą.
