---
title: "DevilRoute — Przewodnik deinstalacji"
version: 3.8.40
lastUpdated: 2026-06-28
---

# DevilRoute — Przewodnik deinstalacji
...
Ten przewodnik opisuje, jak czysto usunąć DevilRoute z systemu.

---

## Szybka deinstalacja (v3.6.2+)

DevilRoute udostępnia dwa wbudowane skrypty do czystego usunięcia:
...
To usuwa aplikację DevilRoute, ale **zachowuje** bazę danych, konfiguracje, klucze API oraz ustawienia providerów w `~/.devilroute/`. Użyj tej opcji, jeśli planujesz ponowną instalację i chcesz zachować swoją konfigurację.
...
- Pliki logów
- Wszystkie pliki w katalogu `~/.devilroute/`
...
- Otwórz `Settings → Apps → DevilRoute → Uninstall`
- Lub uruchom deinstalator NSIS z katalogu instalacji

**macOS:**

- Przeciągnij `DevilRoute.app` z `/Applications` do Kosza
- Usuń dane: `rm -rf ~/Library/Application Support/devilroute`

**Linux:**

- Usuń plik AppImage
- Usuń dane: `rm -rf ~/.devilroute`
...
DevilRoute domyślnie przechowuje dane w następujących lokalizacjach:
