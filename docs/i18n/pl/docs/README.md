---
title: "Dokumentacja DevilRoute"
version: 3.8.40
lastUpdated: 2026-06-28
---

# Dokumentacja DevilRoute

Nawigowalny indeks zestawu dokumentacji DevilRoute. Tematy są pogrupowane według celu, abyś szybko znalazł to, czego potrzebujesz.
...
Proste przewodniki po korzystaniu z DevilRoute — bez wymaganej wiedzy technicznej.

### getting-started/

- [QUICK-START.md](getting-started/QUICK-START.md) — zainstaluj i uruchom DevilRoute w 3 minuty.
- [AUTO-COMBO-GUIDE.md](getting-started/AUTO-COMBO-GUIDE.md) — pozwól DevilRoute wybrać dla Ciebie najlepsze AI.
...
- [SETUP_GUIDE.md](guides/SETUP_GUIDE.md) — pierwsza konfiguracja DevilRoute.
...
- [TIERS.md](guides/TIERS.md) — poziomy DevilRoute wyjaśnione (przewodnik użytkownika).
...
- [DOCKER_GUIDE.md](guides/DOCKER_GUIDE.md) — uruchamianie DevilRoute w Dockerze.
...
- [REMOTE-MODE.md](guides/REMOTE-MODE.md) — udostępnianie DevilRoute zdalnie + tokeny z zakresem (scoped tokens).
- [CLI-INTEGRATIONS.md](guides/CLI-INTEGRATIONS.md) — główna tabela integracji CLI `setup-*`.
- [CLAUDE-CODE-CONFIGURATION.md](guides/CLAUDE-CODE-CONFIGURATION.md) — Claude Code CLI z DevilRoute.
- [CODEX-CLI-CONFIGURATION.md](guides/CODEX-CLI-CONFIGURATION.md) — Codex CLI z DevilRoute.
...
- [DEVILROUTE_VS_ALTERNATIVES.md](comparison/DEVILROUTE_VS_ALTERNATIVES.md) — jak DevilRoute wypada na tle alternatyw.
