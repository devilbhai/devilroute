---
title: "Dokumentacja bazy kodu DevilRoute"
version: 3.8.40
lastUpdated: 2026-06-28
---

# Dokumentacja bazy kodu DevilRoute

> **Wersja:** v3.8.0
> **Ostatnia aktualizacja:** 2026-06-28
> **Odbiorcy:** Inżynierowie współtworzący DevilRoute lub budujący na nim integracje.
>
...
danych to zmienna środowiskowa `DATA_DIR`, domyślnie `~/.devilroute/`.
...
├── open-sse/             Workspace silnika streamingu (@devilroute/open-sse)
├── electron/             Opakowanie desktopowe (Electron 41 main + preload)
├── bin/                  Punkty wejścia CLI (devilroute, reset-password)
...
| `responses.ts`, `devilrouteResponseMeta.ts` | Helpery kształtu odpowiedzi                       |
...
Osobny npm workspace publikowany jako `@devilroute/open-sse`. Odpowiada za
...
```
bin/
├── devilroute.mjs           Główne wejście CLI (Node ESM)
...
- **Importy**: external → internal (`@/`, `@devilroute/open-sse`) → relative.
