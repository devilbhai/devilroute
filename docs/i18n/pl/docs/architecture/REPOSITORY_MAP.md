...
> Ostatnia aktualizacja: 2026-06-28 — DevilRoute v3.8.40
>
...
├── @devilroute/           # Publikowalne pakiety towarzyszące (opencode-plugin, opencode-provider)
├── skills/               # Paczki skilli CLI/agent (cli-* + omni-* + config-codex-cli)
├── examples/             # Przykładowe pluginy + starter devilroute-cmd-hello
...
Osobny workspace npm (`@devilroute/open-sse`). Obsługuje przetwarzanie żądań + wykonanie u providerów.
...
| `preload.js`     | Most IPC (contextBridge → `window.devilroute`)                                       |
...
| Plik                                                                                                        | Cel                                                                                                                           |
| ----------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| `devilroute.mjs`                                                                                             | Główne wejście CLI — `devilroute serve`, `devilroute setup`, `devilroute doctor`, `devilroute providers`, `devilroute combos` itd. |
...
| Plik                         | Cel                                                                                       |
| ---------------------------- | ----------------------------------------------------------------------------------------- |
| `skills/devilroute*/SKILL.md` | 10 manifestów skilli dla zewnętrznych agentów AI (Claude Desktop, ChatGPT, Cursor, Cline) |
...
| `CLI-TOOLS.md`              | Integracje zewnętrznych CLI + wewnętrzne CLI DevilRoute                               |
...
- **`_mono_repo/`** — historyczne podprojekty (devilrouteCloud, devilrouteSite, vscode-extension)
