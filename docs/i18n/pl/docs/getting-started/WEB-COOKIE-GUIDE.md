...
Dostawcy Web Cookie pozwalają DevilRoute korzystać z usługi AI przez istniejącą sesję przeglądarki zamiast klucza API. Są przydatne, gdy masz już dostęp do usługi przez stronę internetową i chcesz, aby DevilRoute używał tej samej uwierzytelnionej sesji.
...
Dla większości dostawców Web Cookie właśnie tę wartość należy wkleić do DevilRoute.
...
## Ciasteczko działa w przeglądarce, ale nie w DevilRoute
