...
Jika Anda menemukan kerentanan keamanan di DevilRoute, harap laporkan secara bertanggung jawab:

1. **JANGAN** membuka isu GitHub yang bersifat publik
2. Gunakan [GitHub Security Advisories](https://github.com/diegosouzapw/DevilRoute/security/advisories/new)
...
DevilRoute menerapkan model keamanan berlapis:
