...
- sebelum akun aktif habis, DevilRoute menghasilkan ringkasan terstruktur yang ringkas
- setelah autentikasi memilih akun berbeda untuk sesi yang sama, DevilRoute menyuntikkan
...
Jika penyedia aktif diaktifkan di `handoffProviders`, DevilRoute menghasilkan ringkasan handoff
...
DevilRoute menambahkan handoff yang tersimpan sebagai pesan sistem. Penyuntikan hanya terjadi setelah
...
Pada saat penyuntikan, DevilRoute mengonversi muatan tersebut menjadi pesan sistem `<context_handoff>`
