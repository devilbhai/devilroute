# DevilRoute — Panduan Deployment di VM dengan Cloudflare (Bahasa Indonesia)
...
Panduan lengkap untuk menginstal dan mengkonfigurasi DevilRoute pada sebuah VM (VPS) dengan domain yang dikelola melalui Cloudflare.
...
Jaga agar timeout stream reverse-proxy tetap selaras dengan variabel lingkungan timeout DevilRoute Anda. Jika Anda menaikkan
...
Lihat dokumentasi lengkap di [devilrouteCloud/README.md](../devilrouteCloud/README.md).
...
| 20128 | DevilRoute   | Hanya localhost (melalui nginx) |
