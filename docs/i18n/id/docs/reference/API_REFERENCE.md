...
Referensi lengkap untuk semua titik akhir API DevilRoute.
...
| ------------------------ | --------- | ------------------------------------------------------------ |
| `X-DevilRoute-No-Cache`   | Permintaan | Atur ke `true` untuk melewati cache                          |
| `X-DevilRoute-Progress`   | Permintaan | Atur ke `true` untuk event progres                           |
...
| `X-DevilRoute-Cache`      | Respons   | `HIT` atau `MISS` (non-streaming)                            |
| `X-DevilRoute-Idempotent` | Respons   | `true` jika dideduplikasi                                    |
| `X-DevilRoute-Progress`   | Respons   | `enabled` jika pelacakan progres aktif                       |
| `X-DevilRoute-Session-Id` | Respons   | ID sesi efektif yang digunakan DevilRoute                     |
