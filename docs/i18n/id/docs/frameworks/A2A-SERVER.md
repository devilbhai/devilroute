# Dokumentasi Server A2A DevilRoute (Bahasa Indonesia)
...
> Protokol Agent-to-Agent v0.3 — DevilRoute sebagai agen routing cerdas
...
Mengembalikan Kartu Agen yang mendeskripsikan kemampuan, keterampilan, dan persyaratan autentikasi DevilRoute.
...
| :----------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `smart-routing`    | Merutekan prompt melalui pipeline cerdas DevilRoute. Mengembalikan respons beserta penjelasan routing, biaya, dan jejak ketahanan.                        |
