# CLI Tools Setup Guide — DevilRoute (Português (Portugal))
...
to use **DevilRoute** as the unified backend, giving you centralized key management,
...
1. Open the DevilRoute dashboard → **API Manager** (`/dashboard/api-manager`)
...
> **Note:** Cursor routes requests through its cloud. For DevilRoute integration,
> enable **Cloud Endpoint** in DevilRoute Settings and use your public domain URL.

Via GUI: **Settings → Models → OpenAI API Key**

- Base URL: `https://your-domain.com/v1`
- API Key: your DevilRoute key

---

## Dashboard Auto-Configuration

The DevilRoute dashboard automates configuration for most tools:
...
**Droid** and **OpenClaw** are AI agents built directly into DevilRoute — no installation needed.
They run as internal routes and use DevilRoute's model routing automatically.
...
| Error                     | Cause                   | Fix                                        |
| ------------------------- | ----------------------- | ------------------------------------------ |
| `Connection refused`      | DevilRoute not running   | `pm2 start devilroute`                      |
...
```bash
# Install all CLIs and configure for DevilRoute (replace with your key and server URL)
