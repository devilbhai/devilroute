---
title: "DevilRoute Documentation"
version: 3.8.40
lastUpdated: 2026-06-28
---

# DevilRoute Documentation

Navigable index of the DevilRoute documentation set. Topics are grouped by intent so you can find what you need quickly.
...
Simple guides for using DevilRoute — no technical background needed.

### getting-started/

- [QUICK-START.md](getting-started/QUICK-START.md) — install and run DevilRoute in 3 minutes.
- [AUTO-COMBO-GUIDE.md](getting-started/AUTO-COMBO-GUIDE.md) — let DevilRoute pick the best AI for you.
...
- [SETUP_GUIDE.md](guides/SETUP_GUIDE.md) — first-time setup of DevilRoute.
...
- [TIERS.md](guides/TIERS.md) — DevilRoute tiers explained (user guide).
...
- [DOCKER_GUIDE.md](guides/DOCKER_GUIDE.md) — running DevilRoute under Docker.
...
- [REMOTE-MODE.md](guides/REMOTE-MODE.md) — exposing DevilRoute remotely + scoped tokens.
- [CLI-INTEGRATIONS.md](guides/CLI-INTEGRATIONS.md) — master table of `setup-*` CLI integrations.
- [CLAUDE-CODE-CONFIGURATION.md](guides/CLAUDE-CODE-CONFIGURATION.md) — Claude Code CLI with DevilRoute.
- [CODEX-CLI-CONFIGURATION.md](guides/CODEX-CLI-CONFIGURATION.md) — Codex CLI with DevilRoute.
...
- [DEVILROUTE_VS_ALTERNATIVES.md](comparison/DEVILROUTE_VS_ALTERNATIVES.md) — how DevilRoute compares to alternatives.
