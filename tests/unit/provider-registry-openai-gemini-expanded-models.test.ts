 ...
 *
 * Scope (minimal): only models that DevilRoute already references throughout
 ...
 * provider registry. We do NOT restore models DevilRoute deliberately curated
 * out (e.g. o1, gpt-4-turbo) nor re-add embedding/TTS/image entries that
 * DevilRoute deliberately keeps in their own typed registries
