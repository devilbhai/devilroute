...
const ROTATION_ENV_KEYS = [
  "DEVILROUTE_ROTATION_ENABLED",
  "DEVILROUTE_ROTATION_RATE_LIMIT_RESET_SECONDS",
  "DEVILROUTE_ROTATION_DISABLE_TAG_WITHOUT_RESET",
...
test("env parse: disable 502, enable 400, set reset seconds + thresholds", () => {
  clearEnv();
  process.env.DEVILROUTE_ROTATE_ON_502 = "false";
  process.env.DEVILROUTE_ROTATE_ON_400 = "true";
  process.env.DEVILROUTE_ROTATION_RATE_LIMIT_RESET_SECONDS = "10";
  process.env.DEVILROUTE_ROTATE_429_THRESHOLD = "6";
  process.env.DEVILROUTE_ROTATE_429_WINDOW_SECONDS = "120";
  rc.resetGlobalRotationConfigForTest();
...
test("recordErrorAndCheckThreshold: sliding window reaches threshold then resets", () => {
  clearEnv();
  process.env.DEVILROUTE_ROTATE_429_THRESHOLD = "3";
  process.env.DEVILROUTE_ROTATE_429_WINDOW_SECONDS = "60";
  rc.resetGlobalRotationConfigForTest();
  const cfg = rc.getGlobalRotationConfig();
...
test("recordErrorAndCheckThreshold: errors outside the window do not accumulate", () => {
  clearEnv();
  process.env.DEVILROUTE_ROTATE_500_THRESHOLD = "3";
  process.env.DEVILROUTE_ROTATE_500_WINDOW_SECONDS = "60";
  rc.resetGlobalRotationConfigForTest();
  const cfg = rc.getGlobalRotationConfig();
...
test("integration: DEVILROUTE_ROTATE_ON_502=false blocks 502 fallback in checkFallbackError", () => {
  clearEnv();
  process.env.DEVILROUTE_ROTATE_ON_502 = "false";
  rc.resetGlobalRotationConfigForTest();
