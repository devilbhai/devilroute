...
import { REGISTRY } from "@devilroute/open-sse/config/providers/index.ts";
import { FREE_MODEL_BUDGETS } from "@devilroute/open-sse/config/freeModelCatalog.data.ts";
...
// fabricated (copied from DevilRoute's own Anthropic catalog) and live-verified
