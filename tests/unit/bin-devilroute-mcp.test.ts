...
describe("bin/devilroute.mjs MCP path handling", () => {
  it("pathToFileURL converts Windows paths to valid file:// URLs", () => {
    ...
    const testPath = "C:\\Users\\test\\projects\\DevilRoute\\bin\\mcp-server.mjs";
  ...
  it("pathToFileURL converts Unix paths to valid file:// URLs", () => {
    ...
    const testPath = "/home/user/projects/DevilRoute/bin/mcp-server.mjs";
    const fileUrl = pathToFileURL(testPath);
