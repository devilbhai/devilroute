...
const BIN_ENTRY = path.join(ROOT, "bin", "devilroute.mjs");
...
test("every bin/devilroute.mjs local import is enforced by check:pack-artifact", () => {
  // The CLI boot path (bin/devilroute.mjs → bin/cli/*) is covered by allowlist PREFIXES,
