...
test("setupPolyfill.ts is allowed in the tarball (bin/devilroute.mjs imports it at startup)", () => {
...
test("findMissingArtifactPaths flags missing root runtime files in the tarball", () => {
  ...
  // above (dist/server.js, bin/devilroute.mjs, package.json, the postinstall scripts).
