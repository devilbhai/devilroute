...
// Regression guard for #3883: the @devilroute/opencode-plugin must ship an
...
const PKG_URL = new URL("../../../@devilroute/opencode-plugin/package.json", import.meta.url);
const TSUP_URL = new URL("../../../@devilroute/opencode-plugin/tsup.config.ts", import.meta.url);
