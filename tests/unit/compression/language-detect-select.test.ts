...
import { detectCompressionLanguage } from "@devilroute/open-sse/services/compression/languageDetector.ts";
import { cavemanCompress } from "@devilroute/open-sse/services/compression/caveman.ts";
