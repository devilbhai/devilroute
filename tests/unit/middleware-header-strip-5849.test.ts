...
} from "@devilroute/open-sse/handlers/chatCore/responseHeaders.ts";
...
test("streaming path strips hop-by-hop and spoofed DevilRoute headers", () => {
  const upstream = new Headers({
    connection: "keep-alive, x-remove-me",
    "keep-alive": "timeout=5",
    "proxy-authenticate": "Basic realm=upstream",
    "x-remove-me": "connection-scoped",
    "x-devilroute-provider": "spoofed-provider",
