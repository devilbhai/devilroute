...
process.env.DATA_DIR = mkdtempSync(join(tmpdir(), "devilroute-embeddings-gemini-dim-"));
...
// so DevilRoute must forward `outputDimensionality` alongside `dimensions` for Gemini
