 ...
 *
 * DevilRoute's runtime Docker image (`Dockerfile`) runs as `USER node` (UID 1000)
 ...
 *
 * This mirrors upstream behavior (decolua/9router) extended to DevilRoute's TS
 * fork and DevilRoute's existing root-detection (`isRoot()`).
 */
