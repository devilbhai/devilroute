...
import { normalizeClaudeHaikuConstraints } from "@devilroute/open-sse/services/claudeHaikuConstraints.ts";
...
// Several DevilRoute paths can still emit these on Haiku targets:
