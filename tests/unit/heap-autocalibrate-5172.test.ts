 ...
 * spawned with a FIXED 512MB heap default (`devilroute serve`) or with no
 ...
 * ceiling scales with the machine. An explicit `DEVILROUTE_MEMORY_MB` still wins
...
test("#5172 an explicit DEVILROUTE_MEMORY_MB still wins over the calibrated default", () => {
