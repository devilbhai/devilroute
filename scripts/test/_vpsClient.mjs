 ...
 *
 * Reusable Phase-3 VPS HTTP client for DevilRoute combo live-smoke tests.
 ...
 *   execFileSync("ssh", ["root@192.168.0.15", "sqlite3", "/root/.devilroute/storage.sqlite", SQL])
...
const VPS_DB_PATH = "/root/.devilroute/storage.sqlite";
...
if (isMain) {
  (async () => {
    console.log("=== DevilRoute VPS Phase-3 Preflight ===");
