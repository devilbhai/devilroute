...
/**
 * Writes BUILD_DEVILROUTE_BASE_PATH into the standalone bundle so container start
 * can compare the baked Next.js basePath against DEVILROUTE_BASE_PATH.
 */
...
function writeSentinel(targetDir) {
  const basePath = normalizeBasePath(process.env.DEVILROUTE_BASE_PATH);
  const sentinel = path.join(targetDir, "BUILD_DEVILROUTE_BASE_PATH");
