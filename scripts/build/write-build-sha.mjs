...
/**
 * write-build-sha.mjs — HEAD sentinel guard for DevilRoute release builds.
 *
 * Writes DEVILROUTE_BUILD_SHA (or git rev-parse --short HEAD) into:
 *   - dist/BUILD_SHA
...
function resolveBuildSha() {
  if (process.env.DEVILROUTE_BUILD_SHA) {
    return process.env.DEVILROUTE_BUILD_SHA.trim();
  }
  try {
