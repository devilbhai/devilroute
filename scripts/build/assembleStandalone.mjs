...
/**
 * assembleStandalone.mjs - Shared standalone bundle assembler for DevilRoute.
 *
 ...
 * CLI esbuild -> bin/devilroute.mjs                            -               Y           -    UNIQUE (prepublish)
...
const EXTRA_MODULE_ENTRIES = [
  ...
  },
  {
    ...
    // `devilroute --mcp` at startup. See #7701.
