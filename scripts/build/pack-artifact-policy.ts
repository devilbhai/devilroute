/**
 * Shared policy for DevilRoute npm publish artifact hygiene.
 *
...
export const APP_STAGING_ALLOWED_EXACT_PATHS: string[] = [
  ...
  // this bare entry the prepublish prune deleted it → every `devilroute` boot of the
  ...
  // this bare entry the prepublish prune (Step 10.7) deletes it → `devilroute serve`
...
export const PACK_ARTIFACT_ROOT_ALLOWED_EXACT_PATHS: string[] = [
  ...
  // Runtime polyfill eagerly imported by bin/devilroute.mjs (Node <22 compat);
...
export const PACK_ARTIFACT_REQUIRED_PATHS: string[] = [
  ...
  "bin/cli/program.mjs",
  // Direct imports of bin/devilroute.mjs — bin/cli/ is only an allowlist PREFIX, so a
  ...
  "bin/nodeRuntimeSupport.mjs",
  "bin/devilroute.mjs",
  // #7808: aliasResolver + its hook file. bin/devilroute.mjs imports
