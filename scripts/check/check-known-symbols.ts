 ...
 *
 * Sources:
 *   - MCP_TOOLS (33 base tools: devilroute_* + compression + agent_skills)
 *   - memoryTools (3): devilroute_memory_*
 *   - skillTools (4): devilroute_skills_*
...
export const KNOWN_MCP_TOOL_NAMES: readonly string[] = [
  ...
  "devilroute_compression_status",
  "devilroute_compression_configure",
  "devilroute_set_compression_engine",
  "devilroute_list_compression_combos",
  "devilroute_compression_combo_stats",
  ...
  // memoryTools (3)
  "devilroute_memory_search",
  "devilroute_memory_add",
  "devilroute_memory_clear",
  // skillTools (4)
  "devilroute_skills_list",
  "devilroute_skills_enable",
  "devilroute_skills_execute",
  "devilroute_skills_executions",
  // gamificationTools (8)
...
async function main(): Promise<void> {
  ...
  const executorsMod = await import("@devilroute/open-sse/executors/index.ts");
  ...
  const strategyDispatchMod =
    await import("@devilroute/open-sse/services/combo/strategyDispatch.ts");
  ...
  // ── (3) Translator pairs ──────────────────────────────────────────────────
  await import("@devilroute/open-sse/translator/bootstrap.ts").then((m) =>
    (m.bootstrapTranslatorRegistry as () => void)()
  );
  const formatsMod = await import("@devilroute/open-sse/translator/formats.ts");
  const registryMod = await import("@devilroute/open-sse/translator/registry.ts");
  ...
  const { MCP_TOOLS } = await import("@devilroute/open-sse/mcp-server/schemas/tools.ts");
  const { memoryTools } = await import("@devilroute/open-sse/mcp-server/tools/memoryTools.ts");
  const { skillTools } = await import("@devilroute/open-sse/mcp-server/tools/skillTools.ts");
  const { gamificationTools } =
    await import("@devilroute/open-sse/mcp-server/tools/gamificationTools.ts");
  const { pluginTools } = await import("@devilroute/open-sse/mcp-server/tools/pluginTools.ts");
  const { notionTools } = await import("@devilroute/open-sse/mcp-server/tools/notionTools.ts");
  const { obsidianTools } = await import("@devilroute/open-sse/mcp-server/tools/obsidianTools.ts");
