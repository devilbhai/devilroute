#!/usr/bin/env node
/**
 * system-info.mjs — DevilRoute System Information Reporter (#280)
 *
...
lines.push("DevilRoute System Information Report");
...
const installedGlobal = run("npm list -g devilroute --depth=0 2>/dev/null | grep devilroute");
lines.push(`Global npm: ${installedGlobal || "not installed globally"}`);

const pm2Status = run("pm2 list 2>/dev/null | grep devilroute | awk '{print $4, $10, $12}'");
