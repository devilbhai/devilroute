...
const explicitBaseUrl = process.env.DEVILROUTE_BASE_URL || "";
  ...
  const testEnv = {
    ...
    ...(explicitBaseUrl
      ...
      : {
          ...
          DEVILROUTE_BASE_URL: baseUrl,
        }),
    DEVILROUTE_E2E_BOOTSTRAP_MODE: process.env.DEVILROUTE_E2E_BOOTSTRAP_MODE || "open",
