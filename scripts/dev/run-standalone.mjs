...
// #2939: honor DEVILROUTE_MEMORY_MB (default 512), the same knob
// `devilroute serve` uses, so Docker users can control the server heap under
...
const maxOldSpaceMb = resolveMaxOldSpaceMb(childEnv.DEVILROUTE_MEMORY_MB);
