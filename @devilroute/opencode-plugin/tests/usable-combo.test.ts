 ...
 * `providerId` field — DevilRoute's `normalizeComboRecord` folds the provider
...
import { isUsableCombo, type DevilRouteRawCombo } from "../src/index.js";
...
function combo(models: DevilRouteRawCombo["models"]): DevilRouteRawCombo {
